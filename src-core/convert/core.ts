...
export type AudioType = "Q&A"|"Q+A"|"Question"|"Answer"|"Important";
    ...
    return new Promise( ( resolve ) => {
        ...
        readQuestions( source.filename, source.name ).then( readQuestions => {
            ...
            let _process = ()=>{
                ...
                if( _current.change || ( !fs.existsSync( fdir.audioFileOf( _current, "Q+A" )) && opts.convert ) ) _current["convertedQ+A"] = false;
